macro( bembel_find_external_dependencies  )
	...
	set_target_properties( check-all                           PROPERTIES FOLDER "3rdParty/glbinding/maintenance" )
	set_target_properties( check-glbinding                     PROPERTIES FOLDER "3rdParty/glbinding/maintenance" )
	set_target_properties( check-glbinding-aux                 PROPERTIES FOLDER "3rdParty/glbinding/maintenance" )
	set_target_properties( check-template                      PROPERTIES FOLDER "3rdParty/glbinding/maintenance" )
...
macro( bembel_Build_Stl_Modules _PACKAGE_NAME )
	SET_PROPERTY(TARGET ${_PACKAGE_NAME} PROPERTY VS_USER_PROPS ${CMAKE_SOURCE_DIR}/cmake/BuildStlModules.props)	
endmacro()
